...
main=ROOT.TFile("Simulated_"+str(reference)+"_fakeWarningDataset.root","RECREATE")
...
cv= ROOT.TCanvas("cv", " ",0,0, 1000,1000)
cv.SetFillColor(0);
cv.SetBorderMode(0);
cv.SetBorderSize(2);
...
cv.SaveAs("output_files/Algo_res.png");
cv.SaveAs("output_files/Algo_res.pdf");
