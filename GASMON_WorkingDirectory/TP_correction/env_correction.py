...
#correction_par="results_Dataset_2021-09-22_2021-10-20"


f = open("../TP_Fit/"+correction_par+".csv", "r")
print("I############################################################")
print("TP Fit parameters are:")
#the input parametrs are declared as variebales as they are neamed in the anal_parameters.csv file
for x in f:
    k=x.split(";",1)
    var=k[0]
...
cv_histo.SaveAs("./output_plots/GasGain-histo_selected.png");
cv_histo.SaveAs("./output_plots/GasGain-histo_selected.pdf");
...
cv_scat.SaveAs("./output_plots/GasGain-scatter_selected.png");
cv_scat.SaveAs("./output_plots/GasGain-scatter_selected.pdf");
